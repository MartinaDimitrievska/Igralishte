                ...
                <form method="POST" action="{{ route('discounts.store') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="mb-2">
                            ...
                            <x-input type="text" name="discount" id="discount" class="mt-1 p-2 border rounded-md w-full" />
                        </div>
                        <div class="mb-2">
                            <x-label for="discount_category_id" class="block text-sm font-medium text-gray-700">{{ __('Категорија') }}</x-label>
                            <div class="columns-2">
                                <select name="discount_category_id" id="discount_category_id" class="border-gray-300 shadow-sm  mt-1 p-2 border rounded-md w-full">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="products" name="products" class="mt-1 p-2 border-gray-300 rounded-md w-full" placeholder="Внесете го бројот на продуктот"/>
                        </div>
                    </div>
