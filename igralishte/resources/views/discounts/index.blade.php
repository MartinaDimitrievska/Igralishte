    ...
    <div class="py-5">
        <div class="max-w-7xl ml-10 mr-4 sm:px-6 lg:px-8">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-4 flex justify-end">
                <a href="{{ route('discounts.create') }}" class="text-black py-2 px-4">
                    {{ __('Додај нов попуст/промо код') }}
                        ...
                        @if($discount->status->name == 'Active')
                            <div class="my-2 border-2 items-center border-slate-100 bg-slate-50 p-2 rounded-lg flex">
                                <div class="flex items-center w-full justify-between">
                                    <span class="ml-3">{{ $discount->name }}</span>
                                    <a href="{{ route('discounts.edit', ['discount' => $discount->id]) }}" class="text-black py-2 px-4">
